...
function Aboutus() {
  const urlValentina = [
    "https://github.com/valentinaReigada",
    "https://www.linkedin.com/in/valentina-reigada-9b06a51ab",
  ];
  const urlEduardo = [
    "https://github.com/AESALVA",
    "https://www.linkedin.com/in/angeleduardosalva",
  ];
        ...
        <div id="profile-valentina">
          ...
          <div className="profile-content">
            <p className="text-center mt-3">
              ...
              Informática.
              <br /> Soy de la provincia de Buenos Aires, <br /> tengo 22 años.
            </p>
          </div>
          <div className="profile-social">
            <ul className="">
              <Link
                onClick={() => redirect(urlValentina[1])}
                to={urlValentina[1]}
              ...
              <Link
                onClick={() => redirect(urlValentina[0])}
                to={urlValentina[0]}
                rel="noopener noreferrer"
                target="_blank"
              >
